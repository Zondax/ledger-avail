...
const fe25519_sdk ed25519_invsqrtamd_sdk = {
    0x78, 0x6c, 0x89, 0x05, 0xcf, 0xaf, 0xfc, 0xa2, 0x16, 0xc2, 0x7b,
    0x91, 0xfe, 0x01, 0xd8, 0x40, 0x9d, 0x2f, 0x16, 0x17, 0x5a, 0x41,
    0x72, 0xbe, 0x99, 0xc8, 0xfd, 0xaa, 0x80, 0x5d, 0x40, 0xea};

static cx_err_t fe25519_add_sdk(fe25519_sdk h, const fe25519_sdk f,
                                const fe25519_sdk g) {
  return cx_math_addm_no_throw(h, f, g, ED25519_FIELD_SIZE,
                               ED25519_SCALAR_BYTES);
}

static cx_err_t fe25519_sub_sdk(fe25519_sdk h, const fe25519_sdk f,
                                const fe25519_sdk g) {
  return cx_math_subm_no_throw(h, f, g, ED25519_FIELD_SIZE,
                               ED25519_SCALAR_BYTES);
}

static cx_err_t fe25519_mul_sdk(fe25519_sdk h, const fe25519_sdk f,
                                const fe25519_sdk g) {
  return cx_math_multm_no_throw(h, f, g, ED25519_FIELD_SIZE,
                                ED25519_SCALAR_BYTES);
}

static cx_err_t fe25519_sq_sdk(fe25519_sdk h, const fe25519_sdk f) {
  return cx_math_multm_no_throw(h, f, f, ED25519_FIELD_SIZE,
                                ED25519_SCALAR_BYTES);
}
...
static cx_err_t fe25519_neg_sdk(fe25519_sdk h, const fe25519_sdk f) {
  return cx_math_subm_no_throw(h, ED25519_FIELD_ZERO, f, ED25519_FIELD_SIZE,
                               ED25519_SCALAR_BYTES);
}
...
static cx_err_t fe25519_cneg_sdk(fe25519_sdk h, const fe25519_sdk f,
                                 unsigned int b) {
  fe25519_sdk negf;
...
static cx_err_t fe25519_pow22523_sdk(fe25519_sdk out, const fe25519_sdk z) {
  return cx_math_powm_no_throw(out, z, ED25519_POW225, ED25519_SCALAR_BYTES,
                               ED25519_FIELD_SIZE, ED25519_SCALAR_BYTES);
}

static cx_err_t ristretto255_sqrt_ratio_m1_sdk(fe25519_sdk x,
                                               const fe25519_sdk u,
                                               const fe25519_sdk v) {
  fe25519_sdk v3;
  fe25519_sdk vxx;
...
static cx_err_t ristretto255_p3_tobytes_sdk(fe25519_sdk s,
                                            const ge25519_p3_sdk *h) {
...
cx_err_t crypto_scalarmult_ristretto255_base_sdk(unsigned char *q,
  ...
  CHECK_CXERROR(cx_ecfp_scalar_mult_no_throw(CX_CURVE_Ed25519, Pxy, t,
                                             ED25519_SCALAR_BYTES));
