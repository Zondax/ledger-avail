...
| Authorize upgrade without checks | :heavy_check_mark:         |                    | `Hash`code_hash<br/>              |
| Apply authorized upgrade         | :heavy_check_mark:         |                    | `Vecu8`code<br/>                  |
...
| Name                        | Nano S+/X/Stax/Flex/Apex P | Nesting            | Arguments                                                                               |
| --------------------------- | -------------------------- | ------------------ | --------------------------------------------------------------------------------------- |
| Transfer allow death        | :heavy_check_mark:         | :heavy_check_mark: | `AccountIdLookupOfT`dest<br/>`CompactBalance`amount<br/>                                |
...
| Transfer keep alive         | :heavy_check_mark:         | :heavy_check_mark: | `AccountIdLookupOfT`dest<br/>`CompactBalance`amount<br/>                                |
...
| Upgrade accounts            | :heavy_check_mark:         |                    | `VecAccountId`who<br/>                                                                  |
| Force set balance           | :heavy_check_mark:         |                    | `AccountIdLookupOfT`who<br/>`CompactBalance`new_free<br/>                               |
| Force adjust total issuance | :heavy_check_mark:         |                    | `AdjustmentDirection`direction<br/>`CompactBalance`delta<br/>                           |
...
| Set controller             | :heavy_check_mark:         | :heavy_check_mark: |  |
| Set validator count        | :heavy_check_mark:         |                    | `Compactu32`new\_<br/> |
| Increase validator count   | :heavy_check_mark:         |                    | `Compactu32`additional<br/> |
| Scale validator count      | :heavy_check_mark:         |                    | `Percent`factor<br/> |
...
| Chill other                | :heavy_check_mark:         |                    | `AccountId`stash<br/> |
| Force apply min commission | :heavy_check_mark:         |                    | `AccountId`validator_stash<br/> |
| Set min commission         | :heavy_check_mark:         |                    | `Perbill`new\_<br/> |
| Payout stakers by page     | :heavy_check_mark:         |                    | `AccountId`validator_stash<br/>`EraIndex`era<br/>`Page`page<br/> |
| Update payee               | :heavy_check_mark:         |                    | `AccountId`controller<br/> |
...
| Schedule after             | :heavy_check_mark:         |                    | `BlockNumber`after<br/>`OptionschedulePeriodBlockNumber`maybe_periodic<br/>`schedulePriority`priority<br/>`Call`call<br/> |
...
| Name                         | Nano S+/X/Stax/Flex/Apex P | Nesting | Arguments                                |
| ----------------------------- | -------------------------- | ------------------ | ------------------------------------------------------------------------------------------ |
| Create application key     | :heavy_check_mark:         |                    | `AppKey`key<br/> |
| Submit data                | :heavy_check_mark:         |                    | `AppData`data<br/> |
| Submit block length proposal | :heavy_check_mark:         |                    | `u32`rows<br/>`u32`cols<br/> |
| Set application key        | :heavy_check_mark:         |                    | `AppKey`old_key<br/>`AppKey`new_key<br/> |
| Set submit data fee modifier | :heavy_check_mark:         |                    | `DispatchFeeModifier`modifier<br/> |
...
| As multi                   | :heavy_check_mark:         | :heavy_check_mark: | `u16`threshold<br/>`VecAccountId`other_signatories<br/>`OptionTimepoint`maybe_timepoint<br/>`Call`call<br/>`Weight`max_weight<br/> |
...
| Set commission claim permission | :heavy_check_mark:         |                    | `PoolId`pool_id<br/>`OptionCommissionClaimPermissionAccountId`permission<br/> |
...
| Set identity               | :heavy_check_mark:         |                    | `IdentityInfo`info<br/> |
...
| Name    | Nano S+/X/Stax/Flex/Apex P | Nesting | Arguments       |
| ----------------------------- | -------------------------- | ------------------ | ------------------------------------------------------------------------------------------ |
| Mandate                    | :heavy_check_mark:         |                    | `Call`call<br/> |
...
| Execute                    | :heavy_check_mark:         |                    | `Compactu64`slot<br/>`AddressedMessage`addr_message<br/>`ValidProof`account_proof<br/>`ValidProof`storage_proof<br/> |
| Source chain froze         |                            |                    | `Compactu32`source_chain_id<br/>`bool`frozen<br/> |
| Send message               | :heavy_check_mark:         |                    | `Message`message<br/>`H256`to<br/>`Compactu32`domain<br/> |
